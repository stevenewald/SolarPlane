...
//============================== Main loop ====================================
using namespace std;
void imuLoop(AHRS* ahrs, int* phaseOfFlightVal, int* firstTimeRunningRcinput, int* printcounter, float* gyroCalibElev, std::chrono::high_resolution_clock::time_point t1, ofstream outputFile)
{
